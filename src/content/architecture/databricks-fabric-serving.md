...
security, so plan for two policy planes and a reconciliation process.
...
Identity and passthrough behavior differs across the four bridge options, so validate before
committing.
